...
public class VisionAutonomous extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        VuforiaTrackables skystoneTargets = this.vuforia
                .loadTrackablesFromAsset("Skystone");
        ...
        // Set the position of the bridge support targets with relation to the origin (center of the
        // field).
        ...
        // Set the position of the perimeter targets with relation to the origin (center of the field).
        ...
        //
        // NOTE: It's very important that you turn *off* your phone's automatic screen rotation
        ...
        // along the Y axis. Z is UP on the robot. This equates to a bearing angle of 0 degrees.
        //
        ...
        // In this example, it is centered (left to right), but forward of the middle of the robot,
        ...
        // e.g. camera is 0 inches to the left of the robot's center, or on its center axis.
        ...
        OpenGLMatrix robotFromCamera = OpenGLMatrix
                ...
                .multiplied(
                        Orientation.getRotationMatrix(
                                ...
                                phoneYRotation, phoneZRotation, phoneXRotation
                        )
                );
        ...
        while (!isStopRequested()) {
            ...
            if (targetVisible) {
                ...
                Orientation rotation = Orientation
                        .getOrientation(lastLocation, EXTRINSIC, XYZ, DEGREES);
                // Roll, pitch, and yaw.
                telemetry.addData(
                        "Rot (deg)",
                        "(%.0f, %.0f, %.0f)",
