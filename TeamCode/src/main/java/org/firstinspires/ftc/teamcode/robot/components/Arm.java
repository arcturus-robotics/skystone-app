...
public class Arm {
    ...
    public Arm(Servo arm, double armMaximumPosition, double armMinimumPosition, Servo leftClaw, double leftClawMaximumPosition, double leftClawMinimumPosition, Servo rightClaw, double rightClawMaximumPosition, double rightClawMinimumPosition) {
        this.arm = arm;
